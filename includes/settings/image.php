               ...
               <tr align="top">
                    ...
                    <td>
                         <select id="thumbnail_size" name="<?php print $this->optionsName; ?>[thumbnail_size]">
                              <option value="none" <?php selected($this->options['thumbnail_size'], 'none'); ?> ><?php _e('No Thumbnail', 'pretty-sidebar-categories'); ?></option>
                              <option value="thumbnail" <?php selected($this->options['thumbnail_size'], 'thumbnail'); ?> ><?php _e('Thumbnail (150x150px)', 'pretty-sidebar-categories'); ?></option>
                              <option value="medium" <?php selected($this->options['thumbnail_size'], 'medium'); ?> ><?php _e('Medium (300x300px)', 'pretty-sidebar-categories'); ?></option>
                              <option value="large" <?php selected($this->options['thumbnail_size'], 'large'); ?> ><?php _e('Large (640x640px)', 'pretty-sidebar-categories'); ?></option>
                    ...
                    <tr align="top">
                         ...
                         <td>
                              <input type="text" name="<?php print $this->optionsName; ?>[small-image][0]" id="small_image" value="<?php echo $this->options['small-image'][0]; ?>" /> X
                              <input type="text" name="<?php print $this->optionsName; ?>[small-image][1]" id="small_image" value="<?php echo $this->options['small-image'][1]; ?>" /> px
                         </td>
                    </tr>
                    <tr align="top">
                         <th valign="top" scope="row"><label for="full_image"><?php _e('Full image size', 'featured-page-widget'); ?></label></th>
                         <td>
                              <input type="text" name="<?php print $this->optionsName; ?>[full-image][0]" id="full_image" value="<?php echo $this->options['full-image'][0]; ?>" /> X
                              <input type="text" name="<?php print $this->optionsName; ?>[full-image][1]" id="full_image" value="<?php echo $this->options['full-image'][1]; ?>" /> px
                         </td>
                    </tr>
                    <tr align="top">
                         <th valign="top" scope="row"><label for="hard_crop"><?php _e('Crop Method', 'featured-page-widget'); ?></label></th>
                         <td>
                              <label><input type="radio" name="<?php print $this->optionsName; ?>[hard-crop]" id="hard_crop_yes" value="1" <?php checked($this->options['hard-crop'], 1); ?> /> <?php _e('Hard - Maintain aspect', 'featured-page-widget'); ?> </label>
                              <input type="radio" name="<?php print $this->optionsName; ?>[hard-crop]" id="hard_crop_no" value="0" <?php checked($this->options['hard-crop'], 0); ?> /> <?php _e('Soft - Proportional resize', 'featured-page-widget'); ?> </label>
                         </td>
                    </tr>
                    <tr align="top">
