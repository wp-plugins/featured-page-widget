...
<p>
    ...
    <select name="<?php print $this->get_field_name('target'); ?>" id="<?php print $this->get_field_id('target'); ?>">
        ...
        <option value="_blank" <?php selected($linktarget, '_blank'); ?>>New Window</option>
        <option value="_top" <?php selected($linktarget, '_top'); ?>>Top Window</option>
    </select>
</p>
<p>
    ...
    <select name="<?php print $this->get_field_name('linkalign'); ?>" id="<?php print $this->get_field_id('linkalign'); ?>">
        <option value="left" <?php selected($linkalign, 'left'); ?> >Left</option>
        <option value="center" <?php selected($linkalign, 'center'); ?> >Center</option>
        <option value="right" <?php selected($linkalign, 'right'); ?> >Right</option>
    </select>
</p>
...
<p>
    ...
    <select name="<?php print $this->get_field_name('imagealign'); ?>" id="<?php print $this->get_field_id('imagealign'); ?>">
        <option value="left" <?php selected($imagealign, 'left'); ?> >Left</option>
        <option value="center" <?php selected($imagealign, 'center'); ?> >Center</option>
        <option value="right" <?php selected($imagealign, 'right'); ?> >Right</option>
    </select>
</p>
<p>
