<div class="wrap">
    ...
    <h2><?php _e('Featured Page Widget'); ?> &raquo; <?php _e('Default Settings'); ?></h2>
        ...
        <div style="width:49%; float:left">
            ...
            <div class="postbox">
                ...
                <div class="table">
                    <table class="form-table">
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_length"><?php _e('Default Content Length'); ?></label></th>
                            <td><input name="featured_page_widget_length" id="featured_page_widget_length" type="text" value="<?php echo $this->featured_page_widget_length; ?>" /></td>
                        </tr>
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_hide_widget"><?php _e('Hide Widget on Selected Page<br /><small>If only one page is selected</small>'); ?></label></th>
                            <td><input name="featured_page_widget_hide_widget" id="featured_page_widget_hide_widget" type="checkbox" value="1" <?php checked($this->featured_page_widget_hide_widget,1); ?> /></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="postbox">
                ...
                <div class="table">
                    <table class="form-table">
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_link_text"><?php _e('Link Text when no link image is present'); ?></label></th>
                            <td><input name="featured_page_widget_link_text" id="featured_page_widget_link_text" type="text" value="<?php print $this->featured_page_widget_link_text; ?>" /></td>
                        </tr>
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_link_title"><?php _e('Link Title to Post'); ?></label></th>
                            <td><input name="featured_page_widget_link_title" id="featured_page_widget_link_title" type="checkbox" value="1" <?php checked($this->featured_page_widget_link_title,1); ?> /></td>
                        </tr>
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_target"><?php _e('Default Link Target'); ?></label></th>
                            <td><select name="featured_page_widget_target" id="featured_page_widget_target">
                                    <option>None</option>
                                    <option value="_blank" <?php if ($this->featured_page_widget_target == '_blank') echo 'selected'; ?>>New Window</option>
                                    <option value="_top" <?php if ($this->featured_page_widget_target == '_top') echo 'selected'; ?>>Top Window</option>
                                </select></td>
                        </tr>
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_link_align"><?php _e('Default Link Alignment'); ?></label></th>
                            <td><select name="featured_page_widget_link_align" id="featured_page_widget_link_align">
                                    <option value="left" <?php if ($this->featured_page_widget_link_align == 'left') print 'selected'; ?> >Left</option>
                                    <option value="center" <?php if ($this->featured_page_widget_link_align == 'center') print 'selected'; ?> >Center</option>
                                    <option value="right" <?php if ($this->featured_page_widget_link_align == 'right') print 'selected'; ?> >Right</option>
                                </select>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="postbox">
                ...
                <div class="table">
                    <table class="form-table">
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_image_align"><?php _e('Default Image Alignment'); ?></label></th>
                            <td><select name="featured_page_widget_image_align" id="featured_page_widget_image_align">
                                    <option value="left" <?php if ($this->featured_page_widget_image_align == 'left') print 'selected'; ?> >Left</option>
                                    <option value="center" <?php if ($this->featured_page_widget_image_align == 'center') print 'selected'; ?> >Center</option>
                                    <option value="right" <?php if ($this->featured_page_widget_image_align == 'right') print 'selected'; ?> >Right</option>
                                </select>
                            </td>
                        </tr>
                        <tr align="top">
                            <th scope="row"><label for="featured_page_widget_image_width"><?php _e('Link Image Width'); ?></label></th>
                            <td><input name="featured_page_widget_image_width" id="featured_page_widget_image_width" type="text" value="<?php print $this->featured_page_widget_image_width; ?>" /></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <?php  else : ?>
            <input type="hidden" name="page_options" value="<?php $this->settingsVarList(); ?>" />
            <?php endif; ?>
    ...
    <div style="width:49%; float:right">
        <div class="postbox" >
            <h3 class="handl" style="margin:0; padding:3px;cursor:default;">About</h3>
        ...
        <div class="postbox">
            <h3 class="handl" style="margin:0; padding:3px;cursor:default;">Usage</h3>
            <div style="padding:5px;">
